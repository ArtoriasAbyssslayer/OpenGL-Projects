...
meshnames = '../build/result-ply/*.ply'
tempdir = 'temp'
resdir = 'images'
res = 1024
spp = 64
...
def render():
    ...
    for mesh in meshesdir:
        ...
        scene = mitsuba.load_file(filename, meshname=mesh, eyepos=xmlpos, spp=spp, res=res, cubescale=cubescale)
        ...
        img = film.bitmap(raw=True).convert(mitsuba.Bitmap.PixelFormat.RGB, mitsuba.Struct.Type.UInt8, srgb_gamma=True)
